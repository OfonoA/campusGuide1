...
const AdminChatPage: React.FC = () => {
  ...
  const actorTone = (msg: ChatMessage) => (msg.sender === 'user' ? 'text-slate-400' : 'text-[#1E6B3B]')
      ...
      <div className="grid min-h-[calc(100vh-240px)] grid-cols-1 overflow-hidden rounded-[8px] border border-slate-200 bg-white shadow-[0_2px_6px_rgba(0,0,0,0.05)] xl:grid-cols-[320px_minmax(0,1fr)]">
        <section className="min-h-0 border-r border-slate-200 bg-[#F5F5F5] px-4 py-5 md:px-5">
          <div className="flex h-full flex-col">
            <div>
              <div className="mb-4">
                <p className="text-[11px] font-semibold uppercase tracking-[0.22em] text-[#1E6B3B]">Admin workspace</p>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-[8px] border border-slate-200 bg-white px-12 py-3 text-sm text-slate-700 outline-none transition focus:border-[#D4AF37] focus:ring-2 focus:ring-[#D4AF37]/30"
                />
              </div>
            ...
            <div className="chat-scroll-area mt-4 min-h-0 flex-1 overflow-y-auto pr-1">
              {isLoading ? (
                ...
                <div className="space-y-3">
                  {filteredChats.map((chat) => (
                    <button
                      ...
                      className={`w-full rounded-[8px] border bg-[#F8F8F8] px-4 py-3.5 text-left transition shadow-[0_2px_6px_rgba(0,0,0,0.05)] ${
        ...
        <section className="flex min-h-0 flex-col overflow-hidden bg-[#F0F2F5]">
          {!selectedChat ? (
              ...
              <div className="border-b border-slate-200 bg-white/95 px-5 py-4 sm:px-6">
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="text-right text-xs text-slate-500">
                    ...
                    <p className="mt-1 font-semibold text-[#1E6B3B]">{selectedChat.title}</p>
                  </div>
                </div>
              </div>
                  ...
                  <div className="mt-6 flex justify-start">
                    <div className="flex items-start gap-4">
                      <div className="flex h-10 w-10 items-center justify-center overflow-hidden rounded-[8px] bg-[#FEF9E6] shadow-[0_2px_6px_rgba(0,0,0,0.05)] ring-1 ring-[#D4AF37]/20">
                        <ShieldCheck className="h-5 w-5 text-[#1E6B3B]" />
                      </div>
